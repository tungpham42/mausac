...
export const footerTranslations: Record<string, Record<string, string>> = {
  vi: {
    ...
    chinese_chess: "Cờ Tướng",
    json_tools: "Công cụ JSON",
    css_tools: "Công cụ CSS",
    general_tools: "Công cụ Tổng quát",
    caro_game: "Trò chơi Caro",
    srt_tools: "Công cụ SRT",
    movies: "Phim",
    fortune_telling: "Bói",
    disc_assessment: "Đánh giá DISC",
    dictionary_lookup: "Tra Từ",
    mbti_test: "Bài kiểm tra MBTI",
    ikigai: "Ikigai",
    talent_assessment: "Đánh giá Tài năng",
    qr_code_tools: "Công cụ Mã QR",
    earthquake_info: "Thông tin Động đất",
    salary: "Lương",
    clifton_strengths: "Điểm mạnh Clifton",
    holland_code: "Mã Holland",
    math_tools: "Công cụ Toán học",
    chill: "Thư giãn",
    speech_tools: "Công cụ Giọng nói",
    bmi_calculator: "Máy tính BMI",
    timer: "Bộ đếm thời gian",
    forex_tools: "Công cụ Forex",
  },
  en: {
  ...
  zh: {
    ...
    movies: "电影",
    fortune_telling: "占卜",
    disc_assessment: "DISC评估",
    dictionary_lookup: "查词",
    mbti_test: "MBTI测试",
    ikigai: "人生意义",
    talent_assessment: "人才评估",
    qr_code_tools: "二维码工具",
    earthquake_info: "地震信息",
    salary: "薪资",
    clifton_strengths: "克利夫顿优势",
    holland_code: "霍兰德代码",
    math_tools: "数学工具",
    chill: "放松",
    speech_tools: "语音工具",
  ...
  fr: {
    ...
    chinese_chess: "Échecs chinois",
    json_tools: "Outils JSON",
    css_tools: "Outils CSS",
    general_tools: "Outils généraux",
    caro_game: "Jeu de Caro",
    srt_tools: "Outils SRT",
    movies: "Films",
    fortune_telling: "Voyance",
    disc_assessment: "Évaluation DISC",
    dictionary_lookup: "Recherche de mots",
    mbti_test: "Test MBTI",
    ikigai: "Ikigai",
    talent_assessment: "Évaluation des talents",
    qr_code_tools: "Outils de code QR",
    earthquake_info: "Informations sur les tremblements de terre",
    salary: "Salaire",
    clifton_strengths: "Forces de Clifton",
    holland_code: "Code Holland",
    math_tools: "Outils mathématiques",
    chill: "Détente",
    speech_tools: "Outils vocaux",
    bmi_calculator: "Calculateur d’IMC",
    timer: "Minuteur",
    forex_tools: "Outils Forex",
  },
  de: {
    explore_more: "Mehr Erkunden",
    chinese_chess: "Chinesisches Schach",
    json_tools: "JSON-Tools",
    css_tools: "CSS-Tools",
    general_tools: "Allgemeine Tools",
    caro_game: "Caro-Spiel",
    srt_tools: "SRT-Tools",
    movies: "Filme",
    fortune_telling: "Wahrsagen",
    disc_assessment: "DISC-Bewertung",
    dictionary_lookup: "Wörterbuchsuche",
    mbti_test: "MBTI-Test",
    ikigai: "Ikigai",
    talent_assessment: "Talentbewertung",
    qr_code_tools: "QR-Code-Tools",
    earthquake_info: "Erdbebeninformationen",
    salary: "Gehalt",
    clifton_strengths: "Clifton-Stärken",
    holland_code: "Holland-Code",
    math_tools: "Mathematische Tools",
    chill: "Entspannung",
    speech_tools: "Sprach-Tools",
  ...
  it: {
    ...
    chinese_chess: "Scacchi cinesi",
    json_tools: "Strumenti JSON",
    css_tools: "Strumenti CSS",
    general_tools: "Strumenti generali",
    caro_game: "Gioco Caro",
    srt_tools: "Strumenti SRT",
    movies: "Film",
    fortune_telling: "Divinazione",
    disc_assessment: "Valutazione DISC",
    dictionary_lookup: "Ricerca di parole",
    mbti_test: "Test MBTI",
    ikigai: "Ikigai",
    talent_assessment: "Valutazione del talento",
    qr_code_tools: "Strumenti per codici QR",
    earthquake_info: "Informazioni sui terremoti",
    salary: "Stipendio",
    clifton_strengths: "Punti di forza di Clifton",
    holland_code: "Codice Holland",
    math_tools: "Strumenti matematici",
    chill: "Relax",
    speech_tools: "Strumenti vocali",
    bmi_calculator: "Calcolatore BMI",
    timer: "Timer",
    forex_tools: "Strumenti Forex",
  },
  ja: {
    explore_more: "さらに探索",
    chinese_chess: "将棋",
    ...
    movies: "映画",
    fortune_telling: "占い",
    disc_assessment: "DISC評価",
    dictionary_lookup: "辞書検索",
    mbti_test: "MBTIテスト",
    ikigai: "生きがい",
    talent_assessment: "才能評価",
    qr_code_tools: "QRコードツール",
    earthquake_info: "地震情報",
    salary: "給料",
    clifton_strengths: "クリフトンの強み",
    holland_code: "ホランドコード",
    math_tools: "数学ツール",
    chill: "リラックス",
    speech_tools: "音声ツール",
    bmi_calculator: "BMI計算機",
    timer: "タイマー",
    forex_tools: "外国為替ツール",
  },
  ko: {
    ...
    movies: "영화",
    fortune_telling: "점술",
    disc_assessment: "DISC 평가",
    dictionary_lookup: "사전 검색",
    mbti_test: "MBTI 테스트",
    ikigai: "이키가이",
    talent_assessment: "인재 평가",
    qr_code_tools: "QR 코드 도구",
    earthquake_info: "지진 정보",
    salary: "급여",
    clifton_strengths: "클리프턴 강점",
    holland_code: "홀랜드 코드",
    math_tools: "수학 도구",
    chill: "휴식",
    speech_tools: "음성 도구",
  ...
  pt: {
    ...
    chinese_chess: "Xadrez chinês",
    json_tools: "Ferramentas JSON",
    css_tools: "Ferramentas CSS",
    general_tools: "Ferramentas gerais",
    caro_game: "Jogo Caro",
    srt_tools: "Ferramentas SRT",
    movies: "Filmes",
    fortune_telling: "Adivinhação",
    disc_assessment: "Avaliação DISC",
    dictionary_lookup: "Pesquisa de palavras",
    mbti_test: "Teste MBTI",
    ikigai: "Ikigai",
    talent_assessment: "Avaliação de talentos",
    qr_code_tools: "Ferramentas de código QR",
    earthquake_info: "Informações sobre terremotos",
    salary: "Salário",
    clifton_strengths: "Forças de Clifton",
    holland_code: "Código Holland",
    math_tools: "Ferramentas matemáticas",
    chill: "Relaxamento",
    speech_tools: "Ferramentas de fala",
    bmi_calculator: "Calculadora de IMC",
    timer: "Temporizador",
    forex_tools: "Ferramentas Forex",
  },
  ru: {
    explore_more: "Исследовать больше",
    chinese_chess: "Китайские шахматы",
    json_tools: "Инструменты JSON",
    css_tools: "Инструменты CSS",
    general_tools: "Общие инструменты",
    caro_game: "Игра Каро",
    srt_tools: "Инструменты SRT",
    movies: "Фильмы",
    fortune_telling: "Гадание",
    disc_assessment: "Оценка DISC",
    dictionary_lookup: "Поиск слов",
    mbti_test: "Тест MBTI",
    ikigai: "Икигай",
    talent_assessment: "Оценка талантов",
    qr_code_tools: "Инструменты QR-кода",
    earthquake_info: "Информация о землетрясениях",
    salary: "Зарплата",
    clifton_strengths: "Сильные стороны Клифтона",
    holland_code: "Код Холланда",
    math_tools: "Математические инструменты",
    chill: "Расслабление",
    speech_tools: "Инструменты речи",
    bmi_calculator: "Калькулятор ИМТ",
    timer: "Таймер",
    forex_tools: "Инструменты Forex",
  },
  es: {
    explore_more: "Explorar Más",
    chinese_chess: "Ajedrez chino",
    json_tools: "Herramientas JSON",
    css_tools: "Herramientas CSS",
    general_tools: "Herramientas generales",
    caro_game: "Juego Caro",
    srt_tools: "Herramientas SRT",
    movies: "Películas",
    fortune_telling: "Adivinación",
    disc_assessment: "Evaluación DISC",
    dictionary_lookup: "Búsqueda de palabras",
    mbti_test: "Prueba MBTI",
    ikigai: "Ikigai",
    talent_assessment: "Evaluación de talentos",
    qr_code_tools: "Herramientas de código QR",
    earthquake_info: "Información sobre terremotos",
    salary: "Salario",
    clifton_strengths: "Fortalezas de Clifton",
    holland_code: "Código Holland",
    math_tools: "Herramientas matemáticas",
    chill: "Relajación",
    speech_tools: "Herramientas de voz",
    bmi_calculator: "Calculadora de IMC",
    timer: "Temporizador",
    forex_tools: "Herramientas Forex",
  },
};
